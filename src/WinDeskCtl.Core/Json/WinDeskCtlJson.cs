...
public static class WinDeskCtlJson
{
    ...
    /// keeps the call AOT-clean; a type missing from <c>WinDeskCtlJsonContext</c> throws here
    ...
    private static JsonSerializerOptions Create()
    {
        ...
        {
            TypeInfoResolver = WinDeskCtlJsonContext.Default,
