...
public class CaptureTypesTests
{
    ...
    public void CaptureInput_RoundTripsThroughJson()
    {
        ...
        CaptureInput? back = JsonSerializer.Deserialize<CaptureInput>(json, DeskctlJson.Options);
    ...
    public void CaptureInput_FormatSerializesAsAString()
    {
        ...
        string json = JsonSerializer.Serialize(
            new CaptureInput(Frame.Parse("virtual"), Format: ImageFormat.Jpeg), DeskctlJson.Options);
