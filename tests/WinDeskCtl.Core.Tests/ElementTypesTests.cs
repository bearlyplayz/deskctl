...
public class ElementTypesTests
{
    ...
    public void ElementNode_RoundTripsThroughJson()
    {
        ...
        ElementNode? back = JsonSerializer.Deserialize<ElementNode>(json, WinDeskCtlJson.Options);
    ...
    public void ElementSelector_RoundTripsThroughJson()
    {
        ...
        string json = JsonSerializer.Serialize(original, WinDeskCtlJson.Options);
        ElementSelector? back = JsonSerializer.Deserialize<ElementSelector>(json, WinDeskCtlJson.Options);
