...
public class WindowTypesTests
{
    ...
    public void WindowInfo_RoundTripsThroughJson()
    {
        ...
        WindowInfo? back = JsonSerializer.Deserialize<WindowInfo>(json, WinDeskCtlJson.Options);
    ...
    public void WindowState_SerializesAsAString()
    {
        ...
        string json = JsonSerializer.Serialize(
            new WindowInfo(1, "t", "p", 1, AnyRect, WindowState.Maximized, false), WinDeskCtlJson.Options);
    ...
    public void WindowActionInput_RoundTripsThroughJson()
    {
        ...
        string json = JsonSerializer.Serialize(original, WinDeskCtlJson.Options);
        WindowActionInput? back = JsonSerializer.Deserialize<WindowActionInput>(json, WinDeskCtlJson.Options);
