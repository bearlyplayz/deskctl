...
at `windeskctl.exe` with the `mcp` argument. It exposes eight tools: [`doctor`](doctor.md),
[`launch`](launch.md), [`windows`](windows.md), [`window_action`](windows.md),
[`capture`](capture.md), [`record`](record.md), [`snapshot`](snapshot.md), [`input`](input.md).
